...
void MIDI::add_pseudo_echo_volume(int channel, int volume)
{
    add_event(CONTROLLER, channel, 30, 8);
    add_event(CONTROLLER, channel, 31, volume);
}

void MIDI::add_pseudo_echo_length(int channel, int length)
{
    add_event(CONTROLLER, channel, 30, 9);
    add_event(CONTROLLER, channel, 31, length);
}
